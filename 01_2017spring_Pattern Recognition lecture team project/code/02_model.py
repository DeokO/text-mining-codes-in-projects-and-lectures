...
economic_error = pickle.load(open('./data/TOTAL/economic_error.pickle', 'rb'))
...
#oshumed
oshumed_error = pickle.load(open('./data/TOTAL/oshumed_error.pickle', 'rb'))
...
### TF-IDF
economic_tfidf_dtm = pickle.load(open('./data/TOTAL/economic_tf_idf_100.pickle', 'rb'))
economic_tfidf_dtm = np.delete(economic_tfidf_dtm, notsure, axis=0)
oshumed_tfidf_dtm = pickle.load(open('./data/TOTAL/oshumed_tf_idf_100.pickle', 'rb'))
oshumed_tfidf_dtm = oshumed_tfidf_dtm[uses]
reuter_tfidf_dtm = pickle.load(open('./data/TOTAL/reuter_tf_idf_100.pickle', 'rb'))

###LDA
economic_LDA = pickle.load(open('./data/TOTAL/economic_LDA_model_100.pickle', 'rb'))
economic_LDA = np.delete(economic_LDA, notsure, axis=0)
oshumed_LDA = pickle.load(open('./data/TOTAL/oshumed_LDA_model_100.pickle', 'rb'))
oshumed_LDA = np.array(oshumed_LDA)[uses]
reuter_LDA = pickle.load(open('./data/TOTAL/reuter_LDA_model_100.pickle', 'rb'))
reuter_LDA = np.array(reuter_LDA)

### Doc2Vec
economic_doc2vec = pickle.load(open('./data/TOTAL/economic_Doc2Vec_model_100.pickle', 'rb'))
economic_doc2vec = np.delete(economic_doc2vec, notsure, axis=0)
oshumed_doc2vec = pickle.load(open('./data/TOTAL/oshumed_Doc2Vec_model_100.pickle', 'rb'))
oshumed_doc2vec = oshumed_doc2vec[uses]
reuter_doc2vec = pickle.load(open('./data/TOTAL/reuter_Doc2Vec_model_100.pickle', 'rb'))
...
outputJAM1.to_csv('./data/TOTAL/PRML_performance.csv')
